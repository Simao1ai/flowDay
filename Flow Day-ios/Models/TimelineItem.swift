...
enum TimelineItem: Identifiable {
    ...
    var id: String {
        ...
        case .calendarEvent(let e): return e.eventIdentifier ?? UUID().uuidString
        case .habit(let h):         return "habit-\(h.id.uuidString)"
        }
    }
    ...
    var isCompleted: Bool {
        ...
        case .habit(let h):  return h.isCompletedToday
        }
    }
}
